...
$client->setClientId('923233126489.apps.googleusercontent.com');
$client->setClientSecret('0h3GDB2btaookUJ4SxDbHshc');
$client->setRedirectUri('https://www.epicns.com/oauth2callback');
$client->setDeveloperKey('923233126489@developer.gserviceaccount.com');
